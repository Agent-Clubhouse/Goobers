...
var exceptions = []exception{
	...
	{Path: "cmd/goobers/runtime_capabilities.go", Line: 243, Value: "self-update", Reason: "CLI command registry key"},
	{Path: "cmd/goobers/runtime_capabilities.go", Line: 244, Value: "self-update", Reason: "CLI command registry lookup"},
