...
var exceptions = []exception{
	...
	{Path: "cmd/goobers/clisynopsis.go", Line: 31, Value: "self-update", Reason: "CLI command registry key"},
	{Path: "cmd/goobers/runtime_capabilities.go", Line: 235, Value: "self-update", Reason: "CLI command registry key"},
	{Path: "cmd/goobers/runtime_capabilities.go", Line: 236, Value: "self-update", Reason: "CLI command registry lookup"},
