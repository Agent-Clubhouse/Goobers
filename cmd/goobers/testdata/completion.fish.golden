...
complete -c goobers -n '__fish_seen_subcommand_from upgrade' -l version -r -d 'One-time Goobers release tag'
complete -c goobers -n '__fish_seen_subcommand_from upgrade' -l channel -r -a 'stable dogfood beta' -d 'Saved installation channel'
complete -c goobers -n '__fish_seen_subcommand_from self-update' -l policy -r -a 'manual on-release on-main' -d 'Update policy'
complete -c goobers -n '__fish_seen_subcommand_from self-update' -l allow-downgrade -d 'Allow an explicitly selected older release with manual policy'
