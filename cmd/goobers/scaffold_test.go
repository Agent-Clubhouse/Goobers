...
func TestScaffoldGooberAndWorkflowValidate(t *testing.T) {
	...
	wantWarnings := []string{
		...
		"WARNING SKILL002 gaggles/example/goobers/reviewer2/goober.yaml Goober/reviewer2: spec.skills declares \"reviewer2\", but no skill package directory was found at \"skills/reviewer2\"",
	}
...
func TestScaffoldScalarNamesValidate(t *testing.T) {
	...
	wantWarnings := []string{
		...
		"WARNING SKILL002 gaggles/example/goobers/123/goober.yaml Goober/123: spec.skills declares \"123\", but no skill package directory was found at \"skills/123\"",
	}
	assertScaffoldValidationWarnings(t, stdout, wantWarnings)
}
