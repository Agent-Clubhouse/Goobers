...
func TestEmitHeartbeatsReadsConstantBytesPerTick(t *testing.T) {
	...
	go emitHeartbeats(ctx, stdout, dir, func() int { return 1 }, tail, nil, 100*time.Millisecond, nil, done)
...
func TestEmitHeartbeatsCarriesTheResourceFootprint(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			go emitHeartbeats(ctx, stdout, tc.dir, func() int { return 1 }, tc.tail, nil, 10*time.Millisecond, nil, done)
