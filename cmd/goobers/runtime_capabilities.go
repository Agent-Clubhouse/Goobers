...
func init() {
	cliCommands = []cliCommand{
		...
		command("backlog-assignment", apicontract.ActionWorkflowExecution, runBacklogAssignment).
		...
		command("check-issue-staleness", apicontract.ActionWorkflowExecution, runCheckIssueStaleness).
