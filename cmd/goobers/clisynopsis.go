...
var synopsisByID = map[string]string{
	...
	"doctor":                 "  goobers doctor (--k8s | --repo | --av-exclusions) [--kubeconfig <path>] [--context <name>] [--report text|json] [--oidc-issuer <url>] [--registry <host>] [--egress <host:port,...>] [--temporal-hostport <host:port>] [--temporal-namespace <name>] [--timeout <duration>] [--work-root <dir>]\n                                preflight Kubernetes, compare repository forge policy, or list and verify antivirus exclusions\n",
