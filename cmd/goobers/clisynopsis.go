...
var synopsisByID = map[string]string{
	...
	"doctor":                 "  goobers doctor (--k8s | --repo) [--kubeconfig <path>] [--context <name>] [--report text|json] [--oidc-issuer <url>] [--registry <host>] [--egress <host:port,...>] [--timeout <duration>]\n                                preflight Kubernetes or compare repository forge policy\n",
	...
	"engine-project":         "  goobers engine-project --gaggle <g> [--temporal-hostport h:p] [--temporal-namespace <name>] <run-id> [path]\n                                write a completed engine run's journal into the instance (experimental)\n",
	"engine-start":           "  goobers engine-start [--gaggle <g>] [--task-queue <q>] [--temporal-hostport h:p] [--temporal-namespace <name>] [--dedupe-key <k>] <workflow> [path]\n                                dispatch one run onto the tier-3 engine (experimental)\n",
	"worker":                 "  goobers worker [--task-queue <q>]... [--temporal-hostport h:p] [--temporal-namespace <name>] [--drain-timeout <dur>] [--work-root <path>] [--instance <path>]\n                                host a Temporal engine worker (tier-3, experimental)\n",
	"dashboard":              "  goobers dashboard [--port=<port|auto>] [--no-open] [--dev-assets=<dir>] [path]\n                                serve and open the local operations portal\n",
	...
	"telemetry-query":        "  goobers telemetry-query [--window <d>] [--aggregate <name>] [--threshold <k=v>] [--format candidate-findings] [--gaggle <name>] [--workflow <name>]\n                                emit versioned candidate findings (a connector stage)\n",
