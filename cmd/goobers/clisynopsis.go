...
var synopsisByID = map[string]string{
	...
	"recovery-restore":       "  goobers recovery-restore --record <record.json> --repository <checkout> --branch <new-branch> [instance]  restore retained implementation\n",
