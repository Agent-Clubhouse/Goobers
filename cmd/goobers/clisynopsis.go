...
var synopsisByID = map[string]string{
	...
	"upgrade":                "  goobers upgrade [--version <tag>] [--channel stable|dogfood|beta] [path]\n                                reconcile a Microsoft-managed daemon and supervisor\n",
	"self-update":            "  goobers self-update [--policy manual|on-release|on-main] [--include-prerelease] [--allow-downgrade] [--branch <name>] [--target <tag>] [--health-ticks <n>] [--health-timeout <duration>] [path]\n                                stage and request a supervised binary update\n",
