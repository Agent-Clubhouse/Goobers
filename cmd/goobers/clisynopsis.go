...
var synopsisByID = map[string]string{
	...
	"engine-start":           "  goobers engine-start [--gaggle <name>] [--temporal-hostport h:p] [--temporal-namespace <name>] [--task-queue <name>] [--dedupe-key <key>] <workflow> [path]\n                                dispatch one run onto the tier-3 engine (experimental)\n",
	...
	"worker":                 "  goobers worker [--task-queue <q>]... [--temporal-hostport h:p] [--temporal-namespace <name>] [--drain-timeout <dur>] [--work-root <path>] [--instance <path>] [--blob-store <path>]\n                                host a Temporal engine worker (tier-3, experimental)\n",
	...
	"backlog-query":          "  goobers backlog-query [--debug] [--read-only | --claim | --reconcile | --release | --route]  query/claim one eligible backlog item (a workflow stage)\n",
