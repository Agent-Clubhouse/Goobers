...
var synopsisByID = map[string]string{
	...
	"approve":                "  goobers approve <run-id> <gate> [path]  approve a paused or escalated gate\n",
	"override":               "  goobers override --rationale=<text> <run-id> <gate> [path]  override a nondeterministic gate\n",
	"rerun-stage":            "  goobers rerun-stage --addendum=<text> <run-id> <stage> [path]  rerun a stage with an instruction addendum\n",
