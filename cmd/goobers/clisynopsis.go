...
var synopsisByID = map[string]string{
	...
	"validate":               "  goobers validate [--json] [--github-annotations] [--check-harness] [--check-repos] [--source-tree [--instance <path>]] [--strict] [path]\n                                validate an instance or checked-in config source tree\n",
	"lint":                   "  goobers lint [--json] [--github-annotations] [--check-harness] [--check-repos] [--source-tree [--instance <path>]] [--strict] [path]\n                                lint config via the single authoritative validation engine (alias for validate)\n",
