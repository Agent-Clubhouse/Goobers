...
// WithExistingBranchCheckout materializes an independent detached checkout of
// a branch already present in the managed mirror. It never fetches or creates a
// managed repository. The checkout is removed after visit.
