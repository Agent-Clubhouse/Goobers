...
func TestOwnedBranchWorkflowDurabilityAndContinuity(t *testing.T) {
	spec := fixtureSpec("select", []apiv1.Task{
		...
		{Name: "author", Type: apiv1.TaskDeterministic, Goal: "author", Run: &apiv1.DeterministicRun{Command: []string{"true"}, Workspace: apiv1.WorkspaceRepo}, Next: wf.TerminalComplete},
	}, nil)
