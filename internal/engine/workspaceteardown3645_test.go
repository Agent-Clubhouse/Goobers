...
func TestProvisionWorkspacePreservesRecoveryTriggerIdentity(t *testing.T) {
	...
	if seen.RunID != env.RunID || seen.Gaggle != env.Gaggle || seen.Stage != "implement" || seen.TriggerRef != env.TriggerRef {
