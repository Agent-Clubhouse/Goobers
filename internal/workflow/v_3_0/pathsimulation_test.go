...
// TestPathSimulationDescendsIntoParallelBranches is this interpreter's own axis: a bare
...
// has no Parallel construct at all, so this is the one shape only this interpreter's
