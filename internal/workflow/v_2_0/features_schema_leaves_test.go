...
var schemaLeafExceptions = map[string]string{
	...
	"workflow.spec.gates.runsOn.os":           "DSL 3.0-only surface (decision 001); registered as gate.runsOn.os in the 3.0 registry, refused on 2.0 by the version router",
	"workflow.spec.gates.runsOn.cpu":          "DSL 3.0-only surface (decision 001); registered as gate.runsOn.cpu in the 3.0 registry, refused on 2.0 by the version router",
	"workflow.spec.gates.runsOn.memory":       "DSL 3.0-only surface (decision 001); registered as gate.runsOn.memory in the 3.0 registry, refused on 2.0 by the version router",
	"workflow.spec.gates.runsOn.disk":         "DSL 3.0-only surface (decision 001); registered as gate.runsOn.disk in the 3.0 registry, refused on 2.0 by the version router",
	"workflow.spec.gates.runsOn.capabilities": "DSL 3.0-only surface (decision 001); registered as gate.runsOn.capabilities in the 3.0 registry, refused on 2.0 by the version router",
	"workflow.spec.gates.runsOn.restrictions": "DSL 3.0-only surface (decision 001); registered as gate.runsOn.restrictions in the 3.0 registry, refused on 2.0 by the version router",
