...
func TestImplementationWorkflowCompiles(t *testing.T) {
	...
	// #2341: open-pr uses provider-neutral PR routing.
	...
	// #2554: local-ci declares this gaggle's own `npm run ci` instead of the
	// Go default `make ci`, finishing what #2174 started on the prose. The
	...
	// #5820: open-pr admits the optional ADO work-item capability so provider-
	// specific runtime linking can still fail closed when that credential is absent.
