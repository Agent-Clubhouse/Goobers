...
func TestApprovedVersionFreshness(t *testing.T) {
	tests := []struct {
		...
		{"semver dev", "v0.5.0-dev", "stable", "", "unknown", false},
		{"nightly pinned", "v0.5.0-nightly.1", "stable", "v0.5.0-nightly.1", "unknown", false},
		{"local build", "v0.5.0+local", "stable", "", "unknown", false},
