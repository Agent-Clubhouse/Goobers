...
func TestNewResolverRejectsMalformedRefs(t *testing.T) {
	cases := []struct {
		...
		{"both env and keychain", []TokenRef{{Name: "gh", Env: "X", Keychain: "goobers/gh"}}},
		{"both file and keychain", []TokenRef{{Name: "gh", File: "y", Keychain: "goobers/gh"}}},
		{"both keychain and store", []TokenRef{{Name: "gh", Keychain: "goobers/gh", Store: "kv/gh"}}},
