...
| Built-in workflow primitives and placement | [`docs/reference/workflow-primitives/`](https://github.com/Agent-Clubhouse/Goobers/blob/main/docs/reference/workflow-primitives/README.md) |
