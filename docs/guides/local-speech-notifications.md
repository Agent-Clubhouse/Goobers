...
Alert text is passed unchanged on the synthesizer process's standard input.
It is never interpolated into a shell command and the sink does not summarize
or paraphrase it.
