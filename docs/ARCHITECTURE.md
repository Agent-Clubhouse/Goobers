...
| 3 — Cloud | Entra ID (OIDC) | **Azure Key Vault** | Target: per-gaggle namespaces + identities and network policy (`SEC-*`); active mode-3 dispatch still uses one worker-wide namespace (#4897) |
