...
> Scope-delta: Selected-source identity conformance from #5122 extends the delivered provider contract. This local verification does not claim live provider writes or deployment.
