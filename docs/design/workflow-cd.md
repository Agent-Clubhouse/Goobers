...
> Status: **Shipped** (WCD-1..7 #454–#461 closed — workflowSource, GitSource last-known-good reconcile, `goobers apply`, configrepo:read grant, isolation pen-test all live; epic #453 awaits close-out audit; header refreshed 2026-08-07) · Area prefix: `WCD` (new) · Milestone: **Workflow CD** (#15)
