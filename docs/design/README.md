...
| Document | Status | Delivered by | Superseded by | Verified |
|---|---|---|---|---|
| [Azure DevOps Provider Parity — the PR lifecycle on ADO](ado-provider-parity.md) | `draft` | — | — | — |
...
| [Design: Decomposition workflow](decomposition-workflow.md) | `draft` | — | — | — |
...
| [External call-out stages](external-call-out-stages.md) | `draft` | — | — | — |
...
| [Design: Human-in-the-Loop — escalation visibility & intervention](human-in-the-loop.md) | `draft` | — | — | — |
...
| [Onboarding first-value ladder & DSL authoring support (#435, #2431, #2430)](onboarding-first-value-ladder.md) | `draft` | — | — | — |
...
| [Validation & CI Enrichment — closing the false-green gaps](validation-and-ci-enrichment.md) | `approved` | — | — | — |
...
| [Design: making `pr-remediation` genuinely capable — evidence, policy, and response (V0.6)](v0/pr-remediation-capability.md) | `draft` | — | — | — |

## `docs/design/v1/`

| Document | Status | Delivered by | Superseded by | Verified |
|---|---|---|---|---|
| [Design: Arbitrary-repo hardening + multi-gaggle instances — V1 epic #34](v1/34-arbitrary-repo-hardening.md) | `draft` | — | — | — |
| [Design: Sandboxing + per-goober credential injection (isolation rung 2) — V1 epic #35](v1/35-sandboxing-per-goober-creds.md) | `draft` | — | — | — |
...
| [Design: Assignment-aware backlog coordination (COORD)](v1/backlog-assignment-coordination.md) | `draft` | — | — | — |
| [Design: CLI robustness — registry-sourced help + generated man pages](v1/cli-surface-and-manpages.md) | `draft` | — | — | — |
| [Design: V1 multi-gaggle + per-repo credential scoping](v1/multi-gaggle-validation.md) | `draft` | — | — | — |
| [Design: Multiple Goober instances coordinating on the same repo](v1/multi-instance-repo-coordination.md) | `draft` | — | — | — |
| [Design: Observability substrate — OTel-standard run data for arbitrary workflows and the Tutor (V1)](v1/observability-substrate.md) | `draft` | — | — | — |
| [Design: Polyglot stacks — .NET/C# first-class, Apple/Android laddered](v1/polyglot-stacks.md) | `draft` | — | — | — |
