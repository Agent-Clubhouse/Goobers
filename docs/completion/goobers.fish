...
complete -c goobers -n '__fish_seen_subcommand_from onboarding; and test (count (commandline -opc)) -eq 2' -f -a 'stub-agent-instructions'
...
complete -c goobers -n '__fish_seen_subcommand_from run' -l github-progress -d 'Publish live progress to a GitHub Check Run'
