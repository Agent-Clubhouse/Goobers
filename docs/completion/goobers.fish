...
complete -c goobers -n '__fish_seen_subcommand_from validate' -l strict -d 'promote config warnings except strict-neutral DVL020, REF012, RNR006, WS001 to validation errors'
...
complete -c goobers -n '__fish_seen_subcommand_from lint' -l strict -d 'promote config warnings except strict-neutral DVL020, REF012, RNR006, WS001 to validation errors'
