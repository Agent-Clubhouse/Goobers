...
export const apiRoutes = {
  "discovery": { method: "GET", path: "/.well-known/goobers", actionClass: "api-metadata" },
  "openapi": { method: "GET", path: "/api/v1/openapi.json", actionClass: "api-metadata" },
  "capabilities": { method: "GET", path: "/api/v1/capabilities", actionClass: "api-metadata" },
