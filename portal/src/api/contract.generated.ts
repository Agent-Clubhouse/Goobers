...
export const apiRoutes = {
  "discovery": { method: "GET", path: "/.well-known/goobers", actionClass: "read-only-navigation" },
  "openapi": { method: "GET", path: "/api/v1/openapi.json", actionClass: "read-only-navigation" },
  "capabilities": { method: "GET", path: "/api/v1/capabilities", actionClass: "read-only-navigation" },
  ...
  "runRecoveryPublish": { method: "POST", path: "/api/v1/runs/{run}/recovery", actionClass: "workflow-execution" },
