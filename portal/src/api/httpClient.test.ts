...
describe("HttpDaemonClient", () => {
  ...
  it("maps every available daemon read route and preserves empty lists", async () => {
    ...
    expect(requests).toEqual([
      ...
      "/api/v1/runs?gaggle=core&workflow=implementation&stage=implement&phase=running&trigger=item&since=2026-07-01T00%3A00%3A00Z&until=2026-07-18T00%3A00%3A00Z&limit=25&cursor=run-page",
      "/api/v1/runs/run-1",
