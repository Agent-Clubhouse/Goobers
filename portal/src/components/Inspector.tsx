...
export function StageDefinitionInspector({ stage }: { stage: WorkflowStage }) {
  return (
    <aside aria-label={`${stage.name} definition`} className="definition-panel">
...
export function AttemptInspector({
  ...
  return (
    <aside aria-label={`${stage.name} attempt inspector`} className="run-inspector">
      <InspectorHeading stage={stage} />
