...
const escalatedRunEvents: RunEvent[] = [
  ...
  },
  {
    ...
    elapsed: "14:37",
    type: "stage.finished",
    title: "Implementation repass complete",
    detail: "The repass improved API coverage, but the portal remained coupled to speculative response shapes.",
    tone: "success",
    stageId: "implement",
    attempt: 2,
  },
  ...
  },
  {
    ...
    attempts: [
      ...
      },
      {
        ...
        startedSeq: 8,
        endedSeq: 9,
        summary: "Addressed the first review verdict and improved endpoint coverage.",
        ...
        artifacts: [
          fixtureArtifact({
            ...
            mediaType: "text/markdown",
            size: "82 B",
            summary: "Policy repass changes and unresolved contract notes.",
            digest: "sha256:4d166e38c3c923b2a32013990a7a4bbc0e3122f36c6b1518fc05be6aa0603f02",
            recordedSeq: 9,
            content: "## Policy repass\n\nThe repass improved endpoint coverage; portal coupling remained.",
          }),
        ],
      },
      {
        ...
        artifacts: [
          fixtureArtifact({
            ...
            digest: "sha256:1f64837dcde846cbe9e311198486892d20066354d012b6bcd1ae8f8053de0e6a",
            recordedSeq: 13,
