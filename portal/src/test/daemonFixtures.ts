...
export function populatedDaemonFixtures(): DaemonFixtures {
  ...
  return {
    ...
    stageUsage: {
      "01JZ402DASHBOARD": [
        { stage: "implement", traversal: 1, inputTokens: 4_000, outputTokens: 8_000, costUSD: 0.75 },
        { stage: "implement", traversal: 2, inputTokens: 8_000, outputTokens: 16_000, costUSD: 1.25 },
        { stage: "review", traversal: 1, inputTokens: 2_000, outputTokens: 6_000, costUSD: 0.4 },
      ],
      "01JZ400FAILED": [
        { stage: "implement", traversal: 1, inputTokens: 16_000, outputTokens: 32_000, costUSD: 2.5 },
        { stage: "review", traversal: 1, inputTokens: 3_000, outputTokens: 5_000, costUSD: 0.4 },
      ],
      "01JZ455ESCALATE": [
        { stage: "implement", traversal: 1, inputTokens: 8_000, outputTokens: 16_000, costUSD: 1.25 },
        { stage: "review", traversal: 1, inputTokens: 5_000, outputTokens: 10_000, costUSD: 0.8 },
      ],
      "01JZ441DAEMONAPI": [
        { stage: "review", traversal: 1, inputTokens: 2_000, outputTokens: 6_000, costUSD: 0.4 },
      ],
