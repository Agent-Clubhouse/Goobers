    ...
    stageUsage: {
      ...
      "01JZ455ESCALATE": [
        ...
        },
        {
          ...
          inputTokens: 5_000,
          outputTokens: 10_000,
          copilotPremiumRequests: 0.8,
          costUSD: 0.8,
        },
      ],
      "01JZ441DAEMONAPI": [
        { stage: "review", traversal: 1, inputTokens: 2_000, outputTokens: 6_000, costUSD: 0.4 },
      ],
    },
    telemetryCosts: {
      scope: "summary",
      since: "2026-07-11T20:00:00Z",
      until: "2026-07-18T20:00:00Z",
      pullRequests: [
        {
          provider: "github",
          externalKind: "pr",
      ...
      issues: [
        {
          ...
          totalAttempts: 2,
          measuredAttempts: 2,
          nativeTotals: [{ unit: "usd", value: 0.42, estimated: false }],
          normalizedTotals: [{ unit: "aiCredits", value: 42, estimated: true }],
          billingModels: [],
          costBases: ["vendor_reported"],
          coverage: {
            totalRuns: 2,
      ...
      usage: [
        {
          ...
          p50Tokens: 15_000,
          p95Tokens: 48_000,
          premiumRequestSamples: 7,
          p50CopilotPremiumRequests: 0.8,
          p95CopilotPremiumRequests: 2.5,
          costSamples: 8,
          p50CostUSD: 0.8,
          p95CostUSD: 2.5,
          retryWasteAttempts: 1,
        ...
        },
        {
          ...
          p50Tokens: 24_000,
          p95Tokens: 48_000,
          premiumRequestSamples: 4,
          p50CopilotPremiumRequests: 1.25,
          p95CopilotPremiumRequests: 2.5,
          costSamples: 4,
          p50CostUSD: 1.25,
          p95CostUSD: 2.5,
        ...
        },
        {
          ...
          p50CopilotPremiumRequests: 0.4,
          p95CopilotPremiumRequests: 0.8,
          costSamples: 4,
          p50CostUSD: 0.4,
          p95CostUSD: 0.8,
          retryWasteAttempts: 0,
